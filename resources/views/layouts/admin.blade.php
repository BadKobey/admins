                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <ul class="nav myaccount-tab-trigger" id="account-page-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="account-dashboard-tab" data-bs-toggle="tab" href="{{url('/admin')}}" role="tab" aria-controls="account-dashboard" aria-selected="true">админ</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="account-logout-tab" href="{{url('admin/products')}}" role="tab" aria-selected="false">Товары</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="account-logout-tab" href="{{url('admin/brands')}}" role="tab" aria-selected="false">Брэнды</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="account-logout-tab" href="{{url('admin/organizations')}}" role="tab" aria-selected="false">Организации</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="account-logout-tab" href="{{url('admin/transports')}}" role="tab" aria-selected="false">ТС</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="widget-item">
                                ...
                                <p class="short-desc mb-2">Здесь можно разместить информацию о компании.</p>
            ...
            <div class="footer-bottom bg-midnight-express py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="copyright">
                                <span class="copyright-text">© 2023 МАГЕЛЛАН СЕРВИС <i class="fa fa-heart text-danger"></i> все <a href="https://hasthemes.com/" rel="noopener" target="_blank">права защищены</a> </span>
                            </div>
                        </div>
                    </div>
                </div>
